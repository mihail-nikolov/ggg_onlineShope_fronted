<template>
  <v-container class="terms-page">
    <div>
      ...
      <h1> ЗА ПОЛЗВАНЕ НА ПРЕДОСТАВЯНИТЕ ОТ ТЪРГОВЕЦА УСЛУГИ      </h1>

      <h2>I. ОБЩИ ПОЛОЖЕНИЯ</h2>
      1. Настоящият документ съдържа Общи условия, съгласно които ТЪРГОВЕЦА предоставя услуги на потребителите/клиентите си посредством Интернет магазина (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>). Тези условия обвързват всички потребители. С натискане на бутона <b>Съгласен съм с общите условия</b>, потребителят/клиентът се съгласява, изцяло приема и се задължава да спазва настоящите Общи условия.
      <br />
      ...
      <br />
      8в. Когато стоката не е налична на склад, доставката е до 5 работни дни
      <h2>        III. ГАРАНЦИОННИ СРОКОВЕ      </h2>

      ТЪРГОВЕЦЪТ предлага гаранционен документ на своите клиенти за дадена закупена стока, ако такъв документ е осигурен от производителя на стоката. Дава се гаранция за монтажът. В документа са описани: адрес и телефон на оторизираните сервизи на закупената стока гаранционните условия на съответните сервизни центрове или производители гаранционен срок на закупената от потребителя/клиента стока.


      <h2>        IV. ЦЕНИ      </h2>

      9. Монтажът на закупен артикул от нас, в наш сервиз е безплатен. Монтажът извън сервизите, а на място желано от клиента, в рамките на София и Русе е 10лв., извън София град и Русе град - по 1 лв./км. В случай, че стоките се изпращат извън територията на Република България, потребителят/клиентът следва да заплати всички митнически и др. такси, свързани с износа.

      <h2>        V. ПРАВА И ЗАДЪЛЖЕНИЯ НА ПОТРЕБИТЕЛЯ/КЛИЕНТА      </h2>

      10. Потребителят/клиентът има възможност да разглежда и да поръчва обявените стоки на Интернет магазина (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>).
      <br />
      ...
      <br />
      13. Потребителят е длъжен да заплати цената на поръчката си според обявеният начин на страницата (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>).
      <br />
      ...
      <ul>
        <li>
          ...
          и признатите международни актове;
        </li>
        <li>
        ...
        <li>
          да не нарушава чужди имуществени или неимуществени, абсолютни или относителни права и интереси, като право на собственост, право на интелектуална
          собственост и др.;
        </li>
        <li>
          да спазва българското законодателство, приложимите чужди закони, правилата на морала и добрите нрави и Интернет етиката при ползване на предоставяните
          от <a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a> услуги;
        </li>
        <li>да уведомява незабавно ТЪРГОВЕЦА  за всеки случай на извършено или открито нарушение при използване на предоставяните услуги;</li>
        <li>
          да не зарежда, изпраща, предава, разпространява или използва по какъвто и да било начин и да не прави достояние на трети лица софтуер,
          компютърни програми, файлове, приложения или други материали, съдържащи компютърни вируси, системи за неоторизиран отдалечен контрол ("троянски коне"),
          компютърни кодове, или материали, предназначени да прекъсват, затрудняват, нарушават или ограничават нормалното функциониране на компютърен хардуер или софтуер
          или телекомуникационните съоръжения или имащи за цел неоторизирано проникване или достъп в чуждестранни ресурси или софтуер;
        </li>
        <li>да не извършва злоумишлени действия;</li>
        <li>
          да обезщети ТЪРГОВЕЦА  и всички трети лица за всички претърпени вреди и пропуснати ползи, включително за всякакви разходи и платени адвокатски възнаграждения,
          настъпили вследствие на предявени искове от и/или платени обезщетения на трети лица във връзка с Интернет страници, хипер-връзки, материали или информация, които
          Потребителят е използвал, разположил на сървъра, изпращал, разпространявал, направил достояние на трети лица или направил достъпни чрез /името на сайта/ в нарушение
          на закона, настоящите Общи условия, Добрите нрави или Интернет етиката;
        </li>
      </ul>
      ...
      <h2>        VI. ПРАВА И ЗАДЪЛЖЕНИЯ НА ТЪРГОВЕЦА      </h2>
      ...
      <br />
      16. ТЪРГОВЕЦА  има право, но не и задължение да запазва материали и информация, разположени на сървъра на (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>).
      <br />
      17. ТЪРГОВЕЦА  има право по всяко време, без уведомяване на Потребителя/клиента, когато последният ползва услугите в нарушение на настоящите условия, както и по преценка на ТЪРГОВЕЦА  да прекрати, спре или промени предоставяните услуги във връзка с ползването на сайта. ТЪРГОВЕЦА  не носи отговорност спрямо потребителите и трети лица за претърпени вреди и пропуснати ползи, настъпили вследствие прекратяването, спирането, променянето или ограничаването на услугите, изтриването, модифицирането, загубването, недостоверността, неточността, или непълнотата на съобщения, материали или информация, пренасяни, използвани, записвани или станали достъпни чрез (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>).
      <br />
      ...
      <h2>        IX. ТЕРМИНОЛОГИЯ      </h2>

      25. Под “Потребител/клиент” се разбира всеки, който е заредил в Интернет страницата (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>) на своя компютър.
      <br />
      ...
      <br />
      27. Интернет магазина  (<a href="http://shop.glassgoldgroup.eu/">shop.glassgoldgroup.eu</a>) е собственост на ТЪРГОВЕЦА.
      <br />
