<template>
  <v-container class="terms-page">
    <div>
      ...
      9. Монтажът извън сервизите, а на място желано от клиента, в рамките на София и Русе е 10лв., извън София и Русе - по 1 лв./км. В случай, че стоките се изпращат извън територията на Република България, потребителят/клиентът следва да заплати всички митнически и др. такси, свързани с износа.
